...
This extension is based on ckan-pages and is customised for http://data.gov.ro to give an easy way to add simple pages to CKAN.
...
Add this plugin to pip installtion command for docker installation. 

```
RUN pip install -e 'git+https://github.com/john21ro/ckanext-pages.git#egg=ckanext-pages'
```
